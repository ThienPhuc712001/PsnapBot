...
def test_authorization_header_logic():
    ...
    print("\n1. Testing local endpoint (should NOT send Authorization header)")
    ...
    print("\n2. Testing remote endpoint (should send Authorization header)")
...
def main():
    ...
    if logic_test_passed:
        ...
        print("\nSkipping endpoint test due to logic test failure")
